...
namespace Shuffull.Site.Migrations
{
    ...
    [Migration("20230303160251_IndexingAndCleaning")]
    partial class IndexingAndCleaning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shuffull.Site.Models.Artist", b =>
                {
            ...
            modelBuilder.Entity("Shuffull.Site.Models.Playlist", b =>
                {
            ...
            modelBuilder.Entity("Shuffull.Site.Models.PlaylistSong", b =>
                {
            ...
            modelBuilder.Entity("Shuffull.Site.Models.Song", b =>
                {
                    b.Property<long>("SongId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shuffull.Site.Models.SongArtist", b =>
                {
            ...
            modelBuilder.Entity("Shuffull.Site.Models.User", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shuffull.Site.Models.Playlist", b =>
                {
                    b.HasOne("Shuffull.Site.Models.User", "User")
                        .WithMany("Playlists")
            ...
            modelBuilder.Entity("Shuffull.Site.Models.PlaylistSong", b =>
                {
                    b.HasOne("Shuffull.Site.Models.Playlist", "Playlist")
                        .WithMany("PlaylistSongs")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shuffull.Site.Models.Song", "Song")
                        .WithMany("PlaylistSongs")
            ...
            modelBuilder.Entity("Shuffull.Site.Models.SongArtist", b =>
                {
                    b.HasOne("Shuffull.Site.Models.Artist", "Artist")
                        .WithMany()
